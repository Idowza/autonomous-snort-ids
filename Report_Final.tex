...
{\large \textnormal{This report represents the culmination of the EECS 994 Capstone Project.}}
}
...
\\\\
As a result of their size (more than 120 GB), the full training datasets and PCAP files are hosted separately on OneDrive:       
